require([
  ...
  fetch(configUrl)
    ...
    .then((config) => {
      ...
      const cssVariables = config.cssBackground;
      headerPanel.style.backgroundColor = cssVariables;

      const cssVariable2 = config.cssLayerDivColor;
      const cssVariable3 = config.cssLayerDivTextColor;
      const cssVariable4 = config.cssSearchButtonColor;

      const layerDiv = document.getElementsByClassName("layerDiv1");
      layerDiv[0].style.backgroundColor = cssVariable2;
      layerDiv[1].style.backgroundColor = cssVariable2;

      layerDiv[0].style.color = cssVariable3;
      layerDiv[1].style.color = cssVariable3;
      ...
      //   // Add your code here that should run when the button is clicked
      // });
      view.when(() => {
        const togglePanelBtn = document.getElementById("toggle-panel-btn");
